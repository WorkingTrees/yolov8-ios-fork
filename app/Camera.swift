...
struct CameraCapturedData {
    ...
    var colorYData: CVPixelBuffer?
    var colorCbCrData: CVPixelBuffer?
}

class Camera: NSObject {
    let onPhotoCapture: (CameraCapturedData) -> Void
    
    init(onPhotoCapture: @escaping (CameraCapturedData) -> Void) {
